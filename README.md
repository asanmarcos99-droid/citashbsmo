...
<html lang="es" class="h-full">
 ...
 <body class="h-full bg-slate-900 text-white">
   ...
   <header class="bg-gradient-to-r from-emerald-600 to-teal-600 p-4 shadow-lg no-print">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
     <div class="flex items-center gap-3">
      ...
      <div>
       <h1 id="hospital-title" class="text-xl font-bold">Hospital Básico San Marcos de Ocotepeque</h1>
       <p id="system-subtitle" class="text-emerald-100 text-sm">Sistema de Citas Médicas</p>
      </div>
     </div>
    <div class="flex items-center gap-2"><select id="doctor-filter" class="bg-white/20 border border-white/30 rounded-lg px-3 py-2 text-white text-sm"> <option value="">Todos los Médicos</option> </select> <span id="available-slots" class="bg-white/20 px-3 py-2 rounded-lg text-sm"></span>
  ...
  <div class="max-w-7xl mx-auto flex gap-0 p-2 overflow-x-auto"><button onclick="showSection('calendar')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="calendar">📅 Calendario</button> <button onclick="showSection('appointments')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="appointments">📋 Lista de Citas</button> <button onclick="showSection('triage-pending')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="triage-pending">🩺 Triajes Pendientes</button> <button onclick="showSection('diagnosis-pending')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="diagnosis-pending">📋 Diagnósticos Pendientes</button> <button onclick="showSection('reassign')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="reassign">🔄 Reasignar Citas</button> <button onclick="showSection('doctors')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="doctors">👨‍⚕️ Doctores</button> <button onclick="showSection('mora')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="mora">📊 Mora Quirúrgica</button> <button onclick="showSection('finance')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="finance">💰 Finanzas</button> <button onclick="showSection('settings')" class="nav-btn px-4 py-2 rounded-lg text-sm font-medium transition-all hover:bg-slate-700 whitespace-nowrap" data-section="settings">⚙️ Configuración</button>
      <!-- Sección Recibir Expediente eliminada -->
   </div>
  </nav><!-- Main Content -->
   <main class="flex-1 p-4 max-w-7xl mx-auto w-full"><!-- Calendar Section -->
    <section id="section-calendar" class="section-content">
     <div class="grid lg:grid-cols-3 gap-4"><!-- Calendar -->
      <div class="lg:col-span-2 bg-slate-800 rounded-xl p-4 border border-slate-700">
       <div class="flex items-center justify-between mb-4"><button onclick="changeMonth(-1)" class="p-2 hover:bg-slate-700 rounded-lg">◀</button>
        <h2 id="calendar-month" class="text-xl font-semibold"></h2><button onclick="changeMonth(1)" class="p-2 hover:bg-slate-700 rounded-lg">▶</button>
       </div>
      ...
      <div class="space-y-4">
       <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
        <h3 class="font-semibold mb-3 flex items-center gap-2">➕ Nueva Cita Rápida</h3>
       ...
       <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
        <h3 class="font-semibold mb-3">📝 Ingresar Dato</h3>
       ...
       <div class="bg-slate-800 rounded-xl p-4 border border-slate-700"><button onclick="showSection('doctors')" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-medium transition-all"> ➕ Agregar Doctor </button>
       </div>
       <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
        <h3 class="font-semibold mb-3">📊 Resumen del Día</h3>
        <div id="day-summary" class="space-y-2 text-sm">
         <p class="text-slate-400">Seleccione un día para ver detalles</p>
        </div>
       </div>
      </div>
     </div>
    ...
    <section id="section-appointments" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <div class="flex items-center justify-between mb-4">
       ...
       <div class="flex gap-2"><button onclick="exportToPDF()" class="bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg text-sm font-medium transition-all">📄 PDF</button> <button onclick="exportToExcel()" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm font-medium transition-all">📊 Excel</button>
       </div>
      </div>
      <div class="grid md:grid-cols-4 gap-3 mb-4">
        <input type="text" id="search-appointment" placeholder="🔍 Buscar por nombre de paciente..." class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" oninput="filterAppointments()">
        <select id="filter-status" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterAppointments()"> <option value="">Todos los estados</option> <option value="programada">Programada</option> <option value="triaje">En Triaje</option> <option value="diagnostico">En Diagnóstico</option> <option value="completada">Completada</option> <option value="cancelada">Cancelada</option> </select>
      ...
      <div class="flex gap-2 mb-4">
        ...
        <button onclick="receiveAllSentByDate()" class="bg-emerald-600 hover:bg-emerald-700 px-4 py-2 rounded-lg text-sm">📥 Marcar como recibido (fecha)</button>
        ...
        <button onclick="showImportOptions()" class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-sm">📤 Importar</button>
        <button onclick="exportAppointmentsExcel()" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm">📊 Exportar Excel</button>
        <button onclick="exportAppointmentsCSV()" class="bg-amber-600 hover:bg-amber-700 px-4 py-2 rounded-lg text-sm">📊 Exportar Access/CSV</button>
      </div>
      </div>
      ...
      <button id="export-imported-csv-pdf" class="bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg text-sm mt-2">📄 Exportar tabla importada a PDF</button>
    ...
    <section id="section-triage-pending" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <h2 class="text-xl font-semibold mb-4">🩺 Triajes Pendientes</h2>
    ...
    <section id="section-triage-completed" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <h2 class="text-xl font-semibold mb-4">✅ Triajes Realizados</h2>
      <div class="grid md:grid-cols-3 gap-3 mb-4"><input type="text" id="search-triage-completed" placeholder="🔍 Buscar por nombre de paciente..." class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" oninput="filterTriagesCompleted()"> <select id="filter-triage-status" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterTriagesCompleted()"> <option value="">Todos los estados</option> <option value="triaje">Solo Triaje</option> <option value="diagnostico">Con Diagnóstico</option> <option value="completada">Con Referencia</option> </select> <select id="filter-triage-doctor" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterTriagesCompleted()"> <option value="">Todos los doctores</option> </select>
      </div>
    ...
    <section id="section-diagnosis-pending" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <h2 class="text-xl font-semibold mb-4">📋 Diagnósticos Pendientes</h2>
    ...
    <section id="section-reassign" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">🔄 Reasignar Citas</h2>
      <div class="flex gap-2"><button onclick="autoReassignAll(this)" class="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2"> 🤖 Reasignar Todas Automáticamente </button> <button onclick="contactAllReassign()" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2"> 📞 Contactar a Todos </button>
       </div>
      </div>
      <div class="grid md:grid-cols-3 gap-3 mb-4"><input type="text" id="reassign-search" placeholder="🔍 Buscar por nombre o identidad..." class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" oninput="filterReassignList()"> <select id="reassign-filter-doctor" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterReassignList()"> <option value="">Todos los doctores</option> </select> <input type="date" id="reassign-filter-date" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterReassignList()">
      </div>
    ...
    <section id="section-doctors" class="section-content hidden">
     <div class="grid lg:grid-cols-2 gap-4"><!-- Add Doctor Form -->
      <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
       <h2 class="text-xl font-semibold mb-4">👨‍⚕️ Agregar Doctor</h2>
       <form id="doctor-form" class="space-y-4" onsubmit="event.preventDefault(); saveDoctor();">
        <div><label class="block text-sm font-medium mb-1">Nombre del Doctor</label> <input type="text" id="doctor-name" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="Dr. Juan Pérez">
        </div>
        ...
        <div><label class="block text-sm font-medium mb-1">Correo Electrónico</label> <input type="email" id="doctor-email" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="doctor@email.com">
        </div>
        <div><label class="block text-sm font-medium mb-1">Servicios Médicos (escriba cada servicio)</label>
        ...
        <div><label class="block text-sm font-medium mb-1">Máximo de Citas por Día</label> <input type="number" id="doctor-max" required min="1" max="50" value="10" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2">
        </div>
        <div><label class="block text-sm font-medium mb-2">Días Disponibles</label>
         <div class="grid grid-cols-4 gap-2"><label class="flex items-center gap-2 text-sm"><input type="checkbox" value="0" class="day-checkbox rounded"> Dom</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="1" class="day-checkbox rounded" checked> Lun</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="2" class="day-checkbox rounded" checked> Mar</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="3" class="day-checkbox rounded" checked> Mié</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="4" class="day-checkbox rounded" checked> Jue</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="5" class="day-checkbox rounded" checked> Vie</label> <label class="flex items-center gap-2 text-sm"><input type="checkbox" value="6" class="day-checkbox rounded"> Sáb</label>
         </div>
        </div>
      ...
      <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
       <h2 class="text-xl font-semibold mb-4">📋 Lista de Doctores</h2>
       <div id="doctors-list" class="space-y-2 max-h-96 overflow-y-auto scrollbar-thin"></div>
      </div>
     </div>
    </section><!-- Mora Quirúrgica Section -->
    <section id="section-mora" class="section-content hidden">
     <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
      <h2 class="text-xl font-semibold mb-4">📊 Análisis de Mora Quirúrgica</h2>
     ...
     <div class="space-y-6"><!-- Financial Summary Cards -->
      <div class="grid md:grid-cols-4 gap-4">
       <div class="bg-gradient-to-br from-green-600 to-green-700 rounded-xl p-4 border border-green-500">
        <p class="text-green-100 text-sm mb-1">💰 Total Ingresos</p>
       ...
       <div class="bg-gradient-to-br from-red-600 to-red-700 rounded-xl p-4 border border-red-500">
        <p class="text-red-100 text-sm mb-1">💸 Total Egresos</p>
       ...
       <div class="bg-gradient-to-br from-amber-600 to-amber-700 rounded-xl p-4 border border-amber-500">
        <p class="text-amber-100 text-sm mb-1">⏳ Por Cobrar</p>
        <p id="pending-payments" class="text-3xl font-bold text-white">L.0.00</p>
        <p class="text-amber-200 text-xs mt-1">Pagos pendientes</p>
       </div>
      </div><!-- Tabs -->
      <div class="flex gap-2 border-b border-slate-700"><button onclick="showFinanceTab('payments')" class="finance-tab px-6 py-3 font-medium border-b-2 border-emerald-600 text-emerald-400" data-tab="payments"> 📊 Reportes de Pagos </button> <button onclick="showFinanceTab('expenses')" class="finance-tab px-6 py-3 font-medium border-b-2 border-transparent text-slate-400 hover:text-white" data-tab="expenses"> 📒 Contabilidad (Egresos) </button>
      </div><!-- Payments Tab -->
      <div id="finance-tab-payments" class="finance-tab-content">
       <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
        <div class="flex items-center justify-between mb-4">
         <h2 class="text-xl font-semibold">💰 Reportes de Pagos (Ingresos)</h2>
         <div class="flex gap-2"><button onclick="exportPaymentsPDF()" class="bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg text-sm font-medium transition-all">📄 PDF</button> <button onclick="exportPaymentsExcel()" class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-lg text-sm font-medium transition-all">📊 Excel</button>
         </div>
        </div><!-- Summary Stats -->
        <div class="grid md:grid-cols-4 gap-3 mb-4">
        ...
        <div class="grid md:grid-cols-3 gap-3 mb-4"><input type="text" id="filter-payment-patient" placeholder="🔍 Buscar por paciente..." class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" oninput="filterPayments()"> <select id="filter-payment-doctor" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterPayments()"> <option value="">Todos los doctores</option> </select> <select id="filter-payment-status" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterPayments()"> <option value="">Todos los estados</option> <option value="completado">Completado</option> <option value="pendiente">Pendiente</option> </select>
        </div>
       ...
       <div class="grid lg:grid-cols-2 gap-4"><!-- Add Expense Form -->
        <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
         ...
         <form id="expense-form" class="space-y-4" onsubmit="event.preventDefault(); saveExpense();">
          <div><label class="block text-sm font-medium mb-1">Tipo de Gasto</label> <select id="expense-type" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2"> <option value="">Seleccione tipo...</option> <option value="salarios">💼 Salarios de Empleados</option> <option value="servicios">⚡ Servicios Públicos (Luz, Agua, etc.)</option> <option value="medicamentos">💊 Medicamentos e Insumos</option> <option value="equipo">🏥 Equipo Médico</option> <option value="mantenimiento">🔧 Mantenimiento</option> <option value="limpieza">🧹 Limpieza y Saneamiento</option> <option value="papeleria">📄 Papelería y Oficina</option> <option value="otros">📦 Otros</option> </select>
          </div>
          <div><label class="block text-sm font-medium mb-1">Descripción</label> <input type="text" id="expense-description" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="Detalle del gasto">
          </div>
        ...
        <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
         <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex gap-2"><button onclick="exportExpensesPDF()" class="bg-red-600 hover:bg-red-700 px-3 py-2 rounded-lg text-sm font-medium transition-all">📄 PDF</button> <button onclick="exportExpensesExcel()" class="bg-green-600 hover:bg-green-700 px-3 py-2 rounded-lg text-sm font-medium transition-all">📊 Excel</button>
          </div>
         </div><!-- Filters -->
         <div class="grid gap-2 mb-4"><select id="filter-expense-type" class="bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm" onchange="filterExpenses()"> <option value="">Todos los tipos</option> <option value="salarios">Salarios</option> <option value="servicios">Servicios Públicos</option> <option value="medicamentos">Medicamentos</option> <option value="equipo">Equipo Médico</option> <option value="mantenimiento">Mantenimiento</option> <option value="limpieza">Limpieza</option> <option value="papeleria">Papelería</option> <option value="otros">Otros</option> </select>
    ...
    <section id="section-settings" class="section-content hidden">
     <div class="space-y-6">
      <!-- Tarjeta de Gestión de Perfiles eliminada -->

      <!-- System Settings -->
      <div class="bg-slate-800 rounded-xl p-6 border border-slate-700">
        <h2 class="text-xl font-semibold mb-4">⚙️ Configuración del Sistema</h2>
        <form id="settings-form" class="space-y-4" onsubmit="event.preventDefault(); saveSettings();">
         <div class="grid md:grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-medium mb-2">🏥 Nombre del Hospital</label> 
            <input type="text" id="settings-hospital" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="Hospital Básico San Marcos de Ocotepeque">
          </div>
          <div>
            <label class="block text-sm font-medium mb-2">📱 Título del Sistema</label> 
            <input type="text" id="settings-system" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="Sistema de Citas Médicas">
          </div>
         </div>
         <div>
          <label class="block text-sm font-medium mb-2">🖼️ URL del Logo</label> 
  ...
  <div id="user-management-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
    <div class="bg-slate-800 rounded-xl max-w-4xl w-full max-h-[95%] overflow-y-auto scrollbar-thin animate-slide my-4">
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <div>
            <h2 class="text-2xl font-bold">👥 Gestión de Perfiles de Usuario</h2>
            <p class="text-sm text-slate-400 mt-1">Crear, editar y administrar perfiles de acceso al sistema</p>
          </div>
          <button onclick="closeModal('user-management-modal')" class="text-slate-400 hover:text-white text-3xl">×</button>
        </div>
        ...
        <div id="tab-create" class="user-tab-content">
          <div class="bg-slate-700/30 rounded-lg p-6 border border-slate-700">
            <h3 class="font-bold mb-4 text-lg">➕ Crear o Editar Perfil de Usuario</h3>
            <form id="user-form" onsubmit="event.preventDefault(); saveUserFromForm();" class="grid md:grid-cols-2 gap-4">
              ...
              <div class="md:col-span-2">
                <div class="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Usado para iniciar sesión en el sistema</p>
                  </div>
                  <div>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Mínimo 6 caracteres recomendado</p>
                  </div>
                </div>
              </div>
              ...
              <div class="md:col-span-2">
                ...
                <input id="user-password-confirm" type="password" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 focus:outline-none focus:border-emerald-500" placeholder="Repetir contraseña">
              </div>

              <div>
                <label class="block text-sm font-medium mb-2">🎭 Rol o Perfil</label>
                <select id="user-role" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-2 focus:outline-none focus:border-emerald-500" onchange="updateRoleDescription()">
                  ...
                  <option value="medico">👨‍⚕️ Médico (citas, triajes, diagnósticos)</option>
                  <option value="enfermeria">💉 Enfermería (triajes y citas)</option>
                  <option value="recepcion">📞 Recepción (citas y calendario)</option>
                  <option value="custom">⚙️ Personalizado (configurable)</option>
                </select>
              ...
              <div id="permissions-list" class="hidden md:col-span-2">
                <label class="block text-sm font-medium mb-3">🔒 Permisos Personalizados</label>
        ...
        <div id="tab-templates" class="user-tab-content hidden">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-slate-700/30 rounded-lg p-4 border border-slate-700 cursor-pointer hover:border-emerald-500 hover:bg-slate-700/50 transition-all" onclick="applyTemplate('medico')">
              <h4 class="font-bold text-lg mb-2">👨‍⚕️ Perfil de Médico</h4>
              <p class="text-sm text-slate-400 mb-3">Acceso completo a citas, triajes y diagnósticos</p>
              <div class="text-xs text-emerald-400 space-y-1">
                <p>✓ Calendario</p>
                <p>✓ Lista de Citas</p>
                <p>✓ Triajes Pendientes</p>
                <p>✓ Diagnósticos</p>
              </div>
            </div>
            ...
            <div class="bg-slate-700/30 rounded-lg p-4 border border-slate-700 cursor-pointer hover:border-emerald-500 hover:bg-slate-700/50 transition-all" onclick="applyTemplate('enfermeria')">
              <h4 class="font-bold text-lg mb-2">💉 Perfil de Enfermería</h4>
            ...
            <div class="bg-slate-700/30 rounded-lg p-4 border border-slate-700 cursor-pointer hover:border-emerald-500 hover:bg-slate-700/50 transition-all" onclick="applyTemplate('recepcion')">
              <h4 class="font-bold text-lg mb-2">📞 Perfil de Recepción</h4>
              <p class="text-sm text-slate-400 mb-3">Acceso básico para gestionar citas</p>
              <div class="text-xs text-emerald-400 space-y-1">
                <p>✓ Calendario</p>
                <p>✓ Lista de Citas</p>
                <p>✓ Reasignar Citas</p>
            ...
            <div class="bg-slate-700/30 rounded-lg p-4 border border-slate-700 cursor-pointer hover:border-emerald-500 hover:bg-slate-700/50 transition-all" onclick="applyTemplate('admin')">
              <h4 class="font-bold text-lg mb-2">👑 Perfil de Administrador</h4>
   ...
   <div id="appointment-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
    <div class="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90%] overflow-y-auto scrollbar-thin animate-slide my-4">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">➕ Nueva Cita</h2><button onclick="closeModal('appointment-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <form id="appointment-form" class="space-y-4" onsubmit="event.preventDefault(); saveAppointment();">
       <div class="grid md:grid-cols-2 gap-4">
        ...
        <div><label class="block text-sm font-medium mb-1">Número de Identidad</label> <input type="text" id="apt-patient-id" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="0000-0000-00000">
        </div>
       </div>
       <div><label class="block text-sm font-medium mb-1">Teléfono de Contacto</label> <input type="tel" id="apt-phone" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="9999-9999">
       </div>
       <div class="grid md:grid-cols-2 gap-4">
       ...
       <div class="bg-slate-700/50 rounded-lg p-4"><label class="block text-sm font-medium mb-2">Programación de Cita</label>
        <div class="grid md:grid-cols-2 gap-4">
         <div><label class="block text-xs text-slate-400 mb-1">Días para la cita</label>
   ...
   <div id="print-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print">
    <div class="bg-slate-800 rounded-xl max-w-md w-full animate-slide">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
      <h2 class="text-xl font-semibold">✅ Cita Guardada</h2><button onclick="closeModal('print-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <p class="text-slate-300 mb-4">La cita ha sido guardada exitosamente. ¿Qué desea hacer?</p>
      <div class="space-y-2"><button onclick="printTicket()" class="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 🖨️ Imprimir Ticket (58mm) </button> <button onclick="downloadPDF()" class="w-full bg-emerald-600 hover:bg-emerald-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 📄 Descargar PDF Simple </button> <button onclick="downloadCompletePDF()" class="w-full bg-purple-600 hover:bg-purple-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 📄 Descargar PDF Completo </button> <button onclick="closeModal('print-modal')" class="w-full bg-slate-600 hover:bg-slate-500 py-3 rounded-lg font-medium transition-all"> Cerrar </button>
      </div>
     </div>
    </div>
   </div><!-- Triage Modal -->
   <div id="triage-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
    <div class="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90%] overflow-y-auto scrollbar-thin animate-slide my-4">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">🩺 Triaje Médico</h2><button onclick="closeModal('triage-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <form id="triage-form" class="space-y-4" onsubmit="event.preventDefault(); saveTriage();"><input type="hidden" id="triage-apt-id">
       ...
       <div class="grid md:grid-cols-2 gap-4">
        <div><label class="block text-sm font-medium mb-1">Presión Arterial</label> <input type="text" id="triage-bp" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="120/80">
        </div>
        <div><label class="block text-sm font-medium mb-1">Frecuencia Cardíaca (bpm)</label> <input type="number" id="triage-hr" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="72">
        </div>
        <div><label class="block text-sm font-medium mb-1">Temperatura (°C)</label> <input type="number" step="0.1" id="triage-temp" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="36.5">
        </div>
        ...
        <div><label class="block text-sm font-medium mb-1">Saturación O₂ (%)</label> <input type="number" id="triage-oxygen" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2" placeholder="98">
        </div>
       </div>
   ...
   <div id="diagnosis-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
    <div class="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90%] overflow-y-auto scrollbar-thin animate-slide my-4">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">📋 Diagnóstico Médico</h2><button onclick="closeModal('diagnosis-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <form id="diagnosis-form" class="space-y-4" onsubmit="event.preventDefault(); saveDiagnosis();"><input type="hidden" id="diagnosis-apt-id">
       ...
       <div><label class="block text-sm font-medium mb-1">Servicio Médico</label> <select id="diagnosis-service" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2"> <option value="">Seleccione servicio...</option> </select>
        <p class="text-xs text-emerald-400 mt-1" id="service-price-display"></p>
       </div>
       <div><label class="block text-sm font-medium mb-1">Diagnóstico</label> <textarea id="diagnosis-text" required class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 h-32" placeholder="Escriba el diagnóstico médico..."></textarea>
       </div>
   ...
   <div id="reference-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
    <div class="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90%] overflow-y-auto scrollbar-thin animate-slide my-4">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">🏥 Referencia Médica</h2><button onclick="closeModal('reference-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
    ...
    <div id="prescription-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print overflow-y-auto">
      <div class="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90%] overflow-y-auto scrollbar-thin animate-slide my-4">
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-xl font-semibold">💊 Generar Receta Médica</h2>
            <button onclick="closeModal('prescription-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
          </div>
          <form id="prescription-form" class="space-y-4" onsubmit="event.preventDefault(); generatePrescription();">
            <div class="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-sm font-medium mb-1">Número de Identidad</label>
            ...
            <div class="grid md:grid-cols-2 gap-4 mt-2">
              <div>
                <label class="block text-sm font-medium mb-1">Médico (seleccione)</label>
              ...
              <div>
                ...
                <input type="text" id="presc-doctor-name" readonly class="w-full bg-slate-600 border border-slate-500 rounded-lg px-3 py-2 text-slate-300" placeholder="Se rellena automáticamente">
              </div>
            </div>
            <div class="mt-3">
              ...
              <div class="grid md:grid-cols-4 gap-2">
                ...
                <div>
                  <select id="presc-med-frequency" class="w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2">
                    ...
                    <option value="Según indicación">Según indicación</option>
                  </select>
                </div>
                <div class="flex items-center">
                  <button type="button" onclick="addMedicationToList()" class="w-full bg-emerald-600 hover:bg-emerald-700 py-2 rounded-lg">+ Añadir</button>
                </div>
              </div>
              <div id="presc-meds-list" class="mt-3 space-y-2 text-sm"></div>
              <p class="text-xs text-slate-400 mt-2">También puede usar el área de notas si necesita instrucciones libres.</p>
              <div class="mt-2">
            ...
            <div id="prescription-actions" class="hidden flex gap-2">
              <button type="button" onclick="printPrescription()" class="flex-1 bg-blue-600 hover:bg-blue-700 py-3 rounded-lg font-medium">🖨️ Imprimir</button>
   ...
   <div id="print-options-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print">
    <div class="bg-slate-800 rounded-xl max-w-md w-full animate-slide">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold" id="print-options-title">Opciones de Impresión</h2><button onclick="closeModal('print-options-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div><input type="hidden" id="print-apt-id"> <input type="hidden" id="print-type">
      <div class="space-y-2"><button onclick="printDocument()" class="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 🖨️ Imprimir </button> <button onclick="downloadDocumentPDF()" class="w-full bg-emerald-600 hover:bg-emerald-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 📄 Descargar PDF </button> <button onclick="generatePDFLink()" class="w-full bg-purple-600 hover:bg-purple-700 py-3 rounded-lg font-medium transition-all flex items-center justify-center gap-2"> 🔗 Generar Enlace PDF </button> <button onclick="closeModal('print-options-modal')" class="w-full bg-slate-600 hover:bg-slate-500 py-3 rounded-lg font-medium transition-all"> Cerrar </button>
      </div>
   </div><!-- Reassign Modal -->
   <div id="reassign-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print">
    <div class="bg-slate-800 rounded-xl max-w-md w-full animate-slide">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">🔄 Reasignar Cita</h2><button onclick="closeModal('reassign-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <form id="reassign-form" class="space-y-4" onsubmit="event.preventDefault(); confirmReassign();"><input type="hidden" id="reassign-id">
       ...
       <div class="bg-blue-600/20 rounded p-3 text-xs text-blue-300 border border-blue-500">
        <strong>💡 Consejo:</strong> Las citas reasignadas permanecerán visibles en la lista con un color diferente. Podrá enviar mensaje de confirmación al paciente.
       </div>
   ...
   <div id="email-modal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50 p-4 no-print">
    <div class="bg-slate-800 rounded-xl max-w-lg w-full animate-slide">
     <div class="p-6">
      <div class="flex items-center justify-between mb-4">
       <h2 class="text-xl font-semibold">📧 Enviar Calendario al Doctor</h2><button onclick="closeModal('email-modal')" class="text-slate-400 hover:text-white text-2xl">×</button>
      </div>
      <div id="email-preview" class="bg-slate-900 rounded-lg p-4 text-sm max-h-64 overflow-y-auto scrollbar-thin mb-4"></div>
      <p class="text-slate-400 text-sm mb-4">El calendario será enviado al correo del doctor seleccionado.</p>
  ...
  <script>
    ...
    async function trySyncLocal() {
      ...
      if (settings && settings.__backendId && String(settings.__backendId).startsWith('local-')) {
        try {
          ...
          const res = await window.dataSdk.create(payload);
          if (res && res.isOk) {
            showToast('Configuración sincronizada con servidor', 'success');
    ...
    async function init() {
      ...
      if (window.dataSdk) {
        ...
        // No SDK available — load from localStorage
      ...
      try {
        if (window.dataSdk && typeof window.dataSdk.create === 'function') {
          ...
          if (result && result.isOk) {
            ...
            showToast('Error al guardar configuración (SDK)', 'error');
            return;
          }
        }
        ...
        btn.disabled = false;
        btn.textContent = 'Guardar Configuración';
        showToast('Configuración guardada (local)', 'success');
      } catch (err) {
    ...
    function calculateAge() {
      ...
      document.getElementById('apt-age').value = age + ' años';
    }
    ...
    function findAvailableSlot() {
      ...
      if (!doctorId) {
        document.getElementById('slot-info').textContent = '⚠️ Seleccione un doctor primero';
      ...
      if (availableSlots.length > 0) {
        ...
        document.getElementById('slot-info').textContent = `✓ Se encontraron ${availableSlots.length} fechas disponibles`;
        ...
        slotsList.innerHTML = `
          <div class="border-t border-slate-600 pt-3 mt-2">
            <p class="text-xs font-medium text-slate-300 mb-2">Próximos 15 cupos disponibles:</p>
        ...
        document.getElementById('slot-info').textContent = '⚠️ No se encontraron cupos disponibles';
        document.getElementById('available-slots-list').innerHTML = '';
      }
    }
    ...
    async function saveAppointment() {
      if (appointments.length >= 999) {
        showToast('Límite de 999 registros alcanzado', 'error');
        return;
      }
      ...
      if (doctor) {
        ...
        if (isVacation) {
          showToast('El doctor está de vacaciones en esa fecha', 'error');
          btn.disabled = false;
          btn.textContent = 'Guardar Cita';
          return;
        }
    ...
    function printAppointmentTicket(aptId) {
      ...
      if (!apt) {
        showToast('Error: No se encontró la cita', 'error');
        return;
      }
      ...
      const originLabels = {
        ...
        'referencia_clinica_privada': 'Ref. Clínica Privada'
      };
      ...
      const ticketHtml = `
        <div style="width: 58mm; font-family: monospace; font-size: 10px; padding: 5mm;">
          <div style="text-align: center; margin-bottom: 3mm;">
            ...
            <span style="font-size: 9px;">Sistema de Citas Médicas</span><br>
          ...
          <div style="margin-bottom: 2mm;">
            <span style="font-size: 8px;">--------------------------------</span><br>
            <strong>HISTORIAL (Últimas 3)</strong><br>
          ...
          <div style="text-align: center; margin-top: 3mm;">
            ...
            <span style="font-size: 8px;">¡Gracias por su visita!</span><br>
      ...
      showToast('✅ Ticket abierto para impresión', 'success');
    }
    ...
    function createNewAppointmentForPatient(aptId) {
      ...
      document.getElementById('apt-age').value = apt.patient_age + ' años';
...
Número de Identidad:    ${apt.patient_id}
Edad:                   ${apt.patient_age} años
...
${patientHistory.length > 0 ? `
HISTORIAL DE CITAS ANTERIORES (Últimas 3)
${'-'.repeat(70)}
...
${'='.repeat(70)}
  ...
  * Traer este comprobante el día de su cita
  * En caso de no poder asistir, avisar con anticipación
...
${'='.repeat(80)}
${hospitalName.toUpperCase()}
SISTEMA DE CITAS MÉDICAS - REPORTE COMPLETO
${'='.repeat(80)}
...
Origen de la Cita:      ${originLabels[apt.origin] || apt.origin}
Estado:                 ${apt.status.toUpperCase()}
Días de Espera:         ${apt.surgical_delay || 0} días
Fecha de Creación:      ${new Date(apt.created_at).toLocaleString()}

`;

      if (doctor) {
        const services = doctor.doctor_services ? JSON.parse(doctor.doctor_services) : [];
        content += `INFORMACIÓN DEL DOCTOR
${'='.repeat(80)}
Nombre:                 ${doctor.doctor_name}
Especialidad:           ${doctor.specialty}
Correo Electrónico:     ${doctor.doctor_email}
Máx. Citas por Día:     ${doctor.doctor_max_appointments || 10}

`;
        if (services.length > 0) {
          content += `SERVICIOS MÉDICOS DISPONIBLES
${'-'.repeat(80)}
...
${h.diagnosis ? `Diagnóstico:    ${h.diagnosis}` : ''}
...
<body>
  ...
  <div class="filters">
    <h3>📊 RESUMEN Y FILTROS APLICADOS</h3>
    ${document.getElementById('search-appointment').value ? `<p><strong>🔍 Búsqueda:</strong> ${document.getElementById('search-appointment').value}</p>` : ''}
    ${document.getElementById('filter-status').value ? `<p><strong>📌 Estado:</strong> ${statusLabels[document.getElementById('filter-status').value]}</p>` : ''}
    ${document.getElementById('filter-doctor').value ? `<p><strong>👨‍⚕️ Doctor:</strong> ${doctors.find(d => d.__backendId === document.getElementById('filter-doctor').value)?.doctor_name || ''}</p>` : ''}
    ${document.getElementById('filter-date-from').value ? `<p><strong>📅 Desde:</strong> ${document.getElementById('filter-date-from').value}</p>` : ''}
    ${document.getElementById('filter-date-to').value ? `<p><strong>📅 Hasta:</strong> ${document.getElementById('filter-date-to').value}</p>` : ''}
    <p><strong>📋 Total de Citas:</strong> ${filtered.length}</p>
  </div>
`;
...
`;
  ...
  <div class="footer">
    ...
    <p>${hospitalName} - Sistema de Citas Médicas</p>
  </div>
</body>
</html>
`;
      ...
      showToast('Abriendo ventana de impresión - Guarde como PDF', 'success');
    }
    ...
    function exportToExcel() {
      ...
      csv += `${hospitalName}\n`;
      csv += `Reporte de Citas Médicas\n`;
      csv += `Generado: ${new Date().toLocaleString()}\n`;
      csv += `Total de citas: ${filtered.length}\n\n`;
      
      // Column headers
      csv += `No.,Paciente,Identidad,Edad,Teléfono,Departamento,Municipio,Barrio/Aldea,Fecha,Hora,Doctor,Especialidad,Origen,Estado,Diagnóstico,Pago,Estado Pago,Reasignada,Fecha Original,Hora Original,Referencia\n`;
    ...
    function addService() {
      ...
      if (name && price >= 0) {
        ...
        showToast('Datos de servicio inválidos', 'error');
      }
    }
    ...
    function renderServicesList() {
      ...
      list.innerHTML = tempServices.map((s, i) => `
        <div class="flex items-center justify-between bg-slate-700 rounded px-3 py-2 text-sm">
          ...
          <button type="button" onclick="removeService(${i})" class="text-red-400 hover:text-red-300">✕</button>
        </div>
      `).join('');
    }
    ...
    function addVacation() {
      ...
      if (start && end && start <= end) {
        ...
        showToast('Fechas de vacaciones inválidas', 'error');
      }
    }
    ...
    function renderVacationList() {
      ...
      list.innerHTML = tempVacations.map((v, i) => `
        <div class="flex items-center justify-between bg-slate-700 rounded px-3 py-2 text-sm">
          ...
          <button type="button" onclick="removeVacation(${i})" class="text-red-400 hover:text-red-300">✕</button>
        </div>
      `).join('');
    }
          ...
          <div class="bg-slate-700 rounded-lg p-4 border border-slate-600">
            <div class="flex items-start justify-between">
              <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Días: ${days.map(d => dayNames[d]).join(', ')}</p>
                <p class="text-xs text-slate-400">Máx citas/día: ${doc.doctor_max_appointments || 10}</p>
                ${services.length > 0 ? `<p class="text-xs text-blue-400 mt-1">Servicios: ${services.length}</p>` : ''}
                ${vacations.length > 0 ? `<p class="text-xs text-amber-400">Vacaciones: ${vacations.length} período(s)</p>` : ''}
              </div>
              <div class="flex gap-2">
                <button onclick="openEmailModal('${doc.__backendId}')" class="p-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-sm" title="Enviar calendario">📧</button>
                <button onclick="editDoctor('${doc.__backendId}')" class="p-2 bg-amber-600 hover:bg-amber-700 rounded-lg text-sm" title="Editar">✏️</button>
                <button onclick="deleteDoctor('${doc.__backendId}', this)" class="p-2 bg-red-600 hover:bg-red-700 rounded-lg text-sm" title="Eliminar">🗑️</button>
              </div>
            </div>
          </div>
        `;
    ...
    function openEmailModal(doctorId) {
      ...
      calendarHtml += '</div>';
      calendarHtml += `<p class="text-xs mt-3 text-slate-400">🔴 Lleno | 🟢 Con citas | ⬜ Disponible</p>`;
        ...
        <div class="bg-slate-700 rounded-lg p-3 border border-slate-600">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-slate-400">${apt.patient_id} | ${apt.patient_age} años</p>
          ...
          <div class="mt-2 flex gap-2 flex-wrap">
            ...
            ${apt.expediente === 'enviado' ? `
              <button onclick="toggleExpedienteStatus('${apt.__backendId}')" class="text-xs bg-yellow-500 hover:bg-yellow-600 px-3 py-1 rounded flex items-center gap-1" title="Expediente: Enviado (clic para marcar recibido)">📤 Enviado</button>
            ` : apt.expediente === 'recibido' ? `
              <button onclick="toggleExpedienteStatus('${apt.__backendId}')" class="text-xs bg-emerald-600 hover:bg-emerald-700 px-3 py-1 rounded flex items-center gap-1" title="Expediente: Recibido">📥 Recibido</button>
            ` : `
              <button onclick="markExpedienteEnviado('${apt.__backendId}')" class="text-xs bg-slate-600 hover:bg-slate-500 px-3 py-1 rounded flex items-center gap-1" title="Marcar expediente como enviado">🗂️ Sin expediente</button>
            `}
            <!-- Print expediente -->
            <button onclick="printExpediente('${apt.__backendId}')" class="text-xs bg-indigo-600 hover:bg-indigo-700 px-3 py-1 rounded" title="Imprimir expediente">📄 Expediente</button>
            <!-- Abrir receta desde cita -->
            <button onclick="openPrescriptionFromAppointment('${apt.__backendId}')" class="text-xs bg-emerald-600 hover:bg-emerald-700 px-3 py-1 rounded">💊 Receta</button>
            ...
            ` : ''}
            ${apt.status === 'triaje' ? `
              <button onclick="openDiagnosisModal('${apt.__backendId}')" class="text-xs bg-emerald-600 hover:bg-emerald-700 px-3 py-1 rounded">Hacer Diagnóstico</button>
              ...
              <button onclick="downloadCompleteTriagePDF('${apt.__backendId}')" class="text-xs bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded">📋 PDF Completo Triaje</button>
            ` : ''}
            ${apt.status === 'diagnostico' || apt.status === 'completada' ? `
              ...
              <button onclick="openPrintOptions('${apt.__backendId}', 'diagnosis')" class="text-xs bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded">Imprimir Diagnóstico</button>
            ` : ''}
            ${apt.reference_hospital ? `
    ...
    function openTriageModal(aptId) {
      ...
      document.getElementById('triage-patient-info').textContent = `${apt.patient_id} | ${apt.patient_age} años | ${apt.doctor_name} - ${apt.specialty}`;
    ...
    function renderTriagePending() {
      ...
      list.innerHTML = pending.map(apt => `
        <div class="bg-slate-700 rounded-lg p-3 flex items-center justify-between">
          <div>
            <h3 class="font-semibold">${apt.patient_name}</h3>
            <p class="text-sm text-slate-400">${apt.date} - ${apt.time} | ${apt.patient_age} años</p>
    ...
    function renderTriagesCompleted() {
      ...
      list.innerHTML = filtered.map(apt => {
        ...
        if (hasReference) {
          ...
          statusBadge = '<span class="text-xs bg-emerald-600 px-2 py-1 rounded">CON DIAGNÓSTICO</span>';
          bgColor = 'bg-emerald-600/20 border-emerald-500';
        } else {
        ...
        return `
          <div class="rounded-lg p-3 border ${bgColor}">
            ...
            <div class="bg-slate-600/50 rounded p-2 mb-2 text-xs">
              <strong class="text-purple-300">📋 SIGNOS VITALES:</strong><br>
              PA: ${apt.triage_blood_pressure} | FC: ${apt.triage_heart_rate} bpm | Temp: ${apt.triage_temperature}°C<br>
              Peso: ${apt.triage_weight} kg | Altura: ${apt.triage_height} cm | SpO₂: ${apt.triage_oxygen}%
            ...
            <div class="bg-emerald-600/20 rounded p-2 mb-2 text-xs border border-emerald-500">
              <strong class="text-emerald-300">🩺 DIAGNÓSTICO:</strong><br>
              ${apt.diagnosis}
            ...
            <div class="bg-red-600/20 rounded p-2 mb-2 text-xs border border-red-500">
              <strong class="text-red-300">🏥 REFERENCIA A:</strong> ${apt.reference_hospital}<br>
...
SIGNOS VITALES
${'='.repeat(80)}
Presión Arterial:       ${apt.triage_blood_pressure}
Frecuencia Cardíaca:    ${apt.triage_heart_rate} bpm
Temperatura:            ${apt.triage_temperature} °C
Saturación O₂:          ${apt.triage_oxygen}%
...
Frecuencia Cardíaca Normal: 60-100 bpm (adultos)
Temperatura Normal:         36.5-37.5 °C
Saturación O₂ Normal:       95-100%
...
${'='.repeat(80)}
- Este documento contiene información médica confidencial
- Los valores fuera del rango normal requieren evaluación médica
- Presentar este documento al médico durante la consulta
- Conservar para el expediente médico del paciente

${'='.repeat(80)}
Documento generado: ${new Date().toLocaleString()}
Personal de Enfermería: _________________________________
...
${'='.repeat(80)}
    ...
    function openDiagnosisModal(aptId) {
      ...
      document.getElementById('diagnosis-patient-info').textContent = `${apt.patient_id} | ${apt.patient_age} años | ${apt.doctor_name} - ${apt.specialty}`;
    ...
    async function saveDiagnosis() {
      ...
      if (result && result.isOk) {
        showToast(`Diagnóstico guardado - Pago procesado: L.${service.price.toFixed(2)}`, 'success');
    ...
    function renderDiagnosisPending() {
      ...
      if (pending.length === 0) {
        list.innerHTML = '<p class="text-slate-400 text-center py-8">No hay diagnósticos pendientes</p>';
        return;
      }
      ...
      list.innerHTML = pending.map(apt => `
        <div class="bg-slate-700 rounded-lg p-3">
          ...
          <div class="text-xs text-slate-400 bg-slate-600 rounded p-2 mt-2">
            <strong>Triaje:</strong> PA: ${apt.triage_blood_pressure} | FC: ${apt.triage_heart_rate} | Temp: ${apt.triage_temperature}°C
          </div>
        </div>
      `).join('');
    }
    ...
    function openReferenceModal(aptId) {
      ...
      document.getElementById('reference-patient-info').textContent = `${apt.patient_id} | ${apt.patient_age} años | ${apt.doctor_name} - ${apt.specialty}`;
      document.getElementById('reference-diagnosis-info').textContent = `Diagnóstico: ${apt.diagnosis || 'N/A'}`;
    ...
    function openPrintOptions(aptId, type) {
      ...
      const titles = {
        ...
        'diagnosis': 'Imprimir Diagnóstico',
        'reference': 'Imprimir Referencia',
        'both': 'Imprimir Diagnóstico y Referencia'
      };
      
      document.getElementById('print-options-title').textContent = titles[type] || 'Opciones de Impresión';
...
<div style="padding: 20px; font-family: Arial, sans-serif;">
  ...
  <p><strong>Edad:</strong> ${apt.patient_age} años</p>
  <p><strong>Fecha:</strong> ${apt.date} ${apt.time}</p>
  <p><strong>Doctor:</strong> ${apt.doctor_name}</p>
  
  <h4>SIGNOS VITALES</h4>
  <table style="width: 100%; border-collapse: collapse;">
    <tr><td style="border: 1px solid #000; padding: 5px;"><strong>Presión Arterial:</strong></td><td style="border: 1px solid #000; padding: 5px;">${apt.triage_blood_pressure}</td></tr>
    <tr><td style="border: 1px solid #000; padding: 5px;"><strong>Frecuencia Cardíaca:</strong></td><td style="border: 1px solid #000; padding: 5px;">${apt.triage_heart_rate} bpm</td></tr>
    <tr><td style="border: 1px solid #000; padding: 5px;"><strong>Temperatura:</strong></td><td style="border: 1px solid #000; padding: 5px;">${apt.triage_temperature} °C</td></tr>
    ...
    <tr><td style="border: 1px solid #000; padding: 5px;"><strong>Saturación O₂:</strong></td><td style="border: 1px solid #000; padding: 5px;">${apt.triage_oxygen}%</td></tr>
  </table>
...
<div style="padding: 20px; font-family: Arial, sans-serif;">
  <h2 style="text-align: center;">${hospitalName.toUpperCase()}</h2>
  <h3 style="text-align: center;">DIAGNÓSTICO MÉDICO</h3>
  <hr>
...
<div style="padding: 20px; font-family: Arial, sans-serif;">
  <h2 style="text-align: center;">${hospitalName.toUpperCase()}</h2>
  <h3 style="text-align: center;">REFERENCIA MÉDICA</h3>
  <hr>
  
  <p><strong>Paciente:</strong> ${apt.patient_name}</p>
  <p><strong>Identidad:</strong> ${apt.patient_id}</p>
  <p><strong>Edad:</strong> ${apt.patient_age} años</p>
  <p><strong>Dirección:</strong> ${apt.department}, ${apt.municipality}, ${apt.neighborhood}</p>
  ...
  <p><strong>Médico Refiere:</strong> ${apt.doctor_name}</p>
  <p><strong>Especialidad:</strong> ${apt.specialty}</p>
  ...
  <div style="margin-top: 50px;">
    ...
    <p>Firma y Sello del Médico</p>
      ...
      printWindow.document.write(`
        <html>
          <head><title>Documento Médico</title></head>
          <body>
            ${content}
    ...
    function downloadDocumentPDF() {
      ...
      if (type === 'triage' || type === 'both') {
        ...
        content += `Número de Identidad:    ${apt.patient_id}\n`;
        content += `Fecha de Nacimiento:    ${apt.patient_birthdate || 'N/A'}\n`;
        content += `Edad:                   ${apt.patient_age} años\n`;
        ...
        content += `${'-'.repeat(80)}\n`;
        content += `Presión Arterial:       ${apt.triage_blood_pressure}\n`;
        content += `Frecuencia Cardíaca:    ${apt.triage_heart_rate} bpm\n`;
        content += `Temperatura:            ${apt.triage_temperature} °C\n`;
        content += `Saturación O₂:          ${apt.triage_oxygen}%\n`;
        ...
        content += `Personal de Enfermería: _________________________________\n`;
      ...
      if (type === 'diagnosis' || type === 'both') {
        ...
        content += `${'='.repeat(80)}\n`;
        content += `${hospitalName.toUpperCase()}\n`;
        content += `DIAGNÓSTICO MÉDICO - REPORTE COMPLETO\n`;
        content += `${'='.repeat(80)}\n\n`;
        ...
        content += `Hora:                   ${apt.time}\n`;
        content += `Médico Tratante:        ${apt.doctor_name}\n`;
        content += `Especialidad:           ${apt.specialty}\n`;
        content += `Fecha de Diagnóstico:   ${apt.diagnosis_date ? new Date(apt.diagnosis_date).toLocaleString() : 'N/A'}\n\n`;
        ...
        content += `${'='.repeat(80)}\n`;
        content += `Documento generado: ${new Date().toLocaleString()}\n\n`;
        content += `Firma del Médico: _______________________________________\n\n`;
      ...
      if (type === 'reference') {
        content += `${'='.repeat(80)}\n`;
        content += `${hospitalName.toUpperCase()}\n`;
        content += `REFERENCIA MÉDICA - FORMATO OFICIAL\n`;
        content += `${'='.repeat(80)}\n\n`;
        
        content += `FECHA DE EMISIÓN: ${apt.reference_date ? new Date(apt.reference_date).toLocaleDateString() : new Date().toLocaleDateString()}\n`;
        ...
        content += `Municipio:              ${apt.municipality}\n`;
        content += `Barrio/Aldea:           ${apt.neighborhood || 'N/A'}\n`;
        content += `Teléfono:               ______________________________\n\n`;
        
        content += `HOSPITAL DE ORIGEN\n`;
        content += `${'-'.repeat(80)}\n`;
        content += `Nombre:                 ${hospitalName}\n`;
        content += `Médico que Refiere:     ${apt.doctor_name}\n`;
        content += `Especialidad:           ${apt.specialty}\n`;
        content += `Fecha de Consulta:      ${apt.date}\n\n`;
        ...
        content += `${'-'.repeat(80)}\n`;
        content += `[  ] Laboratorios        [  ] Radiografías       [  ] Ultrasonido\n`;
        content += `[  ] Electrocardiograma  [  ] TAC                [  ] Resonancia\n`;
        content += `[  ] Otros: _________________________________________________________\n\n`;
        
        content += `${'='.repeat(80)}\n`;
        content += `DATOS DEL MÉDICO QUE REFIERE\n`;
        content += `${'-'.repeat(80)}\n`;
        content += `Nombre:                 ${apt.doctor_name}\n`;
        content += `Especialidad:           ${apt.specialty}\n`;
        content += `Código Médico:          ______________________________\n`;
        content += `Teléfono de Contacto:   ______________________________\n\n`;
        content += `Firma: _____________________________   Sello: ___________________\n\n`;
        
        content += `${'='.repeat(80)}\n`;
        content += `PARA SER LLENADO POR EL HOSPITAL RECEPTOR\n`;
        content += `${'-'.repeat(80)}\n`;
        content += `Fecha de Recepción:     _____/_____/_________\n`;
        content += `Médico que Recibe:      ______________________________\n`;
        ...
        content += `NOTA: Esta referencia es válida por 30 días a partir de su emisión.\n`;
        content += `      El paciente debe presentar este documento junto con su\n`;
        content += `      identificación personal en el hospital receptor.\n`;
        content += `${'='.repeat(80)}\n`;
      }
        ...
        if (result && result.isOk) {
          ...
          setTimeout(() => {
            if (apt.patient_phone) {
              if (confirm('¿Desea enviar mensaje de confirmación al paciente?')) {
    ...
    function renderReassignList() {
      ...
      list.innerHTML = filtered.map(apt => {
        ...
        const reassignedBadge = apt.reassigned ? `<span class="text-xs bg-amber-600 px-2 py-1 rounded">✨ Reasignada desde ${apt.original_date} ${apt.original_time}</span>` : '';
        const originalDoctorInfo = apt.reassigned ? `<p class="text-xs text-slate-400">Médico anterior: ${apt.original_doctor_name || 'N/A'}</p>` : '';
          ...
          <div class="rounded-lg p-3 border ${bgColor}">
            <div class="flex items-center justify-between">
              <div class="flex-1">
                ...
                <p class="text-sm text-slate-400">${apt.patient_id} | ${apt.patient_age} años</p>
                <p class="text-xs text-slate-400">${apt.department}, ${apt.municipality}</p>
                ${apt.patient_phone ? `<p class="text-xs text-green-400">📞 ${apt.patient_phone}</p>` : ''}
                <p class="text-xs text-emerald-400 mt-1">👨‍⚕️ ${apt.doctor_name} - ${apt.specialty}</p>
                ${originalDoctorInfo}
                ${reassignedBadge}
              </div>
              <div class="text-right">
    ...
    function callPatient(phone) {
      ...
      showToast('Abriendo aplicación de llamadas...', 'info');
    }
    ...
    function contactAllReassign() {
      ...
      if (withPhone.length === 0) {
        showToast('No hay pacientes con teléfono registrado', 'error');
        return;
      }
      const hospitalName = settings ? settings.hospital_name : defaultConfig.hospital_name;
      let sentCount = 0;
      if (!confirm(`¿Enviar mensajes de confirmación a ${withPhone.length} paciente(s) por WhatsApp?`)) {
        return;
      }
      withPhone.forEach((apt, index) => {
        setTimeout(() => {
          ...
          const fechaActualizacion = new Date().toLocaleString('es-HN', { hour12: false });
          const message = `Hola ${apt.patient_name},\n\n✅ Su cita médica ha sido confirmada para el día ${apt.date} a las ${apt.time} en ${hospitalName}.\n👨‍⚕️ Doctor: ${apt.doctor_name}\n${apt.reassigned ? '\n✨ Su cita ha sido reasignada.' : ''}\n\nFecha de actualización: ${fechaActualizacion}\n\nPor favor confirme su asistencia respondiendo este mensaje.\n\n¡Gracias!`;
          const encodedMessage = encodeURIComponent(message);
          window.open(`https://wa.me/504${phone}?text=${encodedMessage}`, '_blank');
          sentCount++;
        }, index * 1500);
      });
      showToast(`📱 Enviando ${withPhone.length} mensaje(s) de confirmación...`, 'success');
    }
    ...
    async function autoReassignAll(btnElem) {
      ...
      modal.innerHTML = `
        <div class="bg-slate-800 rounded-xl max-w-md w-full animate-slide">
          <div class="p-6">
            <h2 class="text-xl font-semibold mb-4">🔄 Reasignar ${filtered.length} Cita(s)</h2>
    ...
    async function performBulkReassign(aptIds) {
      ...
      if (successCount > 0) {
        showToast(`✅ ${successCount} cita(s) reasignada(s) exitosamente${errorCount > 0 ? ` (${errorCount} error(es))` : ''}`, 'success');
        
        // Ask if user wants to send confirmation messages
        setTimeout(() => {
          const withPhone = confirmedApts.filter(apt => apt.patient_phone);
          if (withPhone.length > 0 && confirm(`¿Desea enviar mensajes de confirmación a ${withPhone.length} paciente(s)?`)) {
            contactAllReassign();
          }
        }, 500);
      } else {
        showToast(`❌ No se pudieron reasignar las citas. ${errorCount} error(es).`, 'error');
      }
    }

    // Mora Quirúrgica Analysis
    function renderMoraAnalysis() {
      ...
      if (waitingAppts.length === 0) {
        moraList.innerHTML = '<p class="text-slate-400 text-center py-8">No hay pacientes en espera quirúrgica</p>';
        return;
      }
        ...
        return `
          <div class="rounded-lg p-3 border ${bgColor}">
            <div class="flex items-center justify-between">
              <div>
                <h3 class="font-semibold">${apt.patient_name}</h3>
                <p class="text-sm text-slate-400">${apt.specialty} | ${apt.patient_age} años</p>
              </div>
              <div class="text-right">
                <p class="text-2xl font-bold ${isCritical ? 'text-red-400' : 'text-amber-400'}">${apt.surgical_delay}</p>
                <p class="text-xs text-slate-400">días de espera</p>
              </div>
            </div>
    ...
    function renderCustomDataList() {
      ...
      const sdkHtml = sdkItems.map(item => `
        <div class="flex items-center justify-between bg-slate-700 rounded px-3 py-1 mb-1">
          ...
          <button onclick="deleteCustomDataSdk('${item.id}')" class="text-red-400 hover:text-red-300">✕</button>
        </div>
      `).join('');
      ...
      const localHtml = localItems.map((it, i) => `
        <div class="flex items-center justify-between bg-slate-700 rounded px-3 py-1 mb-1">
          <span>${it}</span>
          <button onclick="removeCustomData(${i})" class="text-red-400 hover:text-red-300">✕</button>
        </div>
      `).join('');
    ...
    async function addSampleDoctorsIfNeeded() {
      ...
      if (doctors.length === 0) {
        const sampleDoctors = [
          {
            type: 'doctor',
            doctor_name: 'Dr. Carlos Hernández',
            ...
            doctor_services: JSON.stringify([
              ...
              { name: 'Control de Presión', price: 100 },
              { name: 'Revisión de Rutina', price: 120 }
            ]),
            created_at: new Date().toISOString()
          },
          {
            ...
            doctor_vacations: JSON.stringify([]),
            doctor_services: JSON.stringify([
              { name: 'Consulta Pediátrica', price: 180 },
              { name: 'Control de Niño Sano', price: 150 },
              { name: 'Vacunación', price: 200 }
            ]),
            created_at: new Date().toISOString()
          },
          {
            ...
            doctor_vacations: JSON.stringify([]),
            doctor_services: JSON.stringify([
              { name: 'Consulta Quirúrgica', price: 250 },
              { name: 'Evaluación Pre-operatoria', price: 200 },
          ...
          {
            type: 'doctor',
            doctor_name: 'Dra. Ana Patricia López',
            ...
            doctor_vacations: JSON.stringify([]),
            doctor_services: JSON.stringify([
              { name: 'Consulta Ginecológica', price: 220 },
          ...
          },
          {
            ...
            doctor_vacations: JSON.stringify([]),
            doctor_services: JSON.stringify([
              { name: 'Consulta Cardiológica', price: 300 },
              { name: 'Electrocardiograma', price: 250 },
              { name: 'Control de Hipertensión', price: 200 }
            ]),
            created_at: new Date().toISOString()
          }
        ];
        ...
        try { saveAllToLocal(); } catch (e) { /* ignore */ }
        showToast('5 médicos de muestra agregados exitosamente', 'success');
      }
    }
...
<body>
  <div class="header">
    <h1>${hospitalName}</h1>
    <p style="margin: 5px 0; color: #64748b;">Sistema de Citas Médicas</p>
    <p style="margin: 5px 0; color: #64748b;">Factura Médica</p>
  </div>
  ...
  <div class="invoice-info">
    <div class="box" style="flex: 1; margin-right: 10px;">
      ...
      <p><strong>Identidad:</strong> ${apt.patient_id}</p>
      <p><strong>Edad:</strong> ${apt.patient_age} años</p>
      <p><strong>Dirección:</strong> ${apt.department}, ${apt.municipality}</p>
    </div>
  ...
  <div class="box" style="margin-bottom: 20px;">
    ...
    <p><strong>Doctor:</strong> ${apt.doctor_name}</p>
    <p><strong>Especialidad:</strong> ${apt.specialty}</p>
    ${apt.diagnosis ? `<p><strong>Diagnóstico:</strong> ${apt.diagnosis}</p>` : ''}
  </div>
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>Consulta Médica - ${apt.specialty}</td>
        <td>1</td>
  ...
  <div class="box" style="background: #f0fdf4; border-color: #10b981;">
    <p style="color: #059669; font-weight: bold; margin: 0;">✅ PAGO COMPLETADO</p>
  ...
  <div class="box" style="background: #fffbeb; border-color: #f59e0b;">
    <p style="color: #d97706; font-weight: bold; margin: 0;">⏳ PAGO PENDIENTE</p>
  ...
  <div class="footer">
    ...
    <p>Este documento es una factura oficial generada por el Sistema de Citas Médicas</p>
        ...
        <div class="bg-slate-700 rounded-lg p-3 border border-slate-600">
          <div class="flex items-center justify-between">
            <div class="flex-1">
              ...
              ${expense.expense_employee ? `<p class="text-xs text-emerald-400">👤 ${expense.expense_employee}</p>` : ''}
...
<body>
  ...
  <div class="footer">
    ...
    function exportExpensesExcel() {
      ...
      csv += `No.,Fecha,Tipo,Descripción,Empleado,Monto,Notas\n`;
